...
Task
labquiz 12
Define class Customer. private string members name, unique_id; public: Customer(),
Customer(string name, string unique_id), string get_name(),
string get_unique_id(), void set_name(string input_name),
